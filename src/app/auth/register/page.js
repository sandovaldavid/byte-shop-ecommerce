...
import { AiOutlineUser, AiOutlineMail, AiOutlineLock, AiOutlineGoogle } from 'react-icons/ai';
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="flex items-center text-sm">
                        <label className="flex items-center text-light/70 hover:text-light cursor-pointer group">
                            ...
                            Acepto los{' '}
                            <Link href="/terms" className="text-secondary hover:text-accent1 transition-colors ml-1">
